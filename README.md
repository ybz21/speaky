...
<tr>
<td>🐧 <b>Linux</b></td>
<td><code>Speaky_1.0.5_amd64.deb</code></td>
<td>
...
<td>🍎 <b>macOS</b></td>
<td>
<code>Speaky_1.0.5_aarch64.dmg</code> (Apple Silicon)<br>
<code>Speaky_1.0.5_x64.dmg</code> (Intel)
</td>
<td>
...
<tr>
<td>🪟 <b>Windows</b></td>
<td><code>Speaky_1.0.5_x64-setup.exe</code></td>
<td>
...
| 平台 | 输出文件 | 大小（约） |
|------|----------|-----------|
| Linux | `target/release/bundle/deb/Speaky_1.0.5_amd64.deb` | 80-120 MB |
| macOS (Apple Silicon) | `target/release/bundle/dmg/Speaky_1.0.5_aarch64.dmg` | 60-100 MB |
| macOS (Intel) | `target/release/bundle/dmg/Speaky_1.0.5_x64.dmg` | 60-100 MB |
| Windows | `target/release/bundle/nsis/Speaky_1.0.5_x64-setup.exe` | 70-110 MB |
