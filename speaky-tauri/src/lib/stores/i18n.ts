...
const zhCN = {
  ...
  "settings.hotkeyHint": "点击右侧，然后直接按下目标键",
  "settings.hotkeyChange": "点击重新录入",
  "settings.hotkeyRecording": "请按一个键…",
  "settings.hotkeyQuickChoices": "常用按键",
  "settings.hotkeyUnsupported": "系统未识别这个按键，请换一个再试",
  "settings.hotkeyTimeout": "没有检测到按键，请重新点击录入",
  "settings.hotkeyUnavailable": "按键监听尚未就绪，请稍后再试",
  "settings.hotkeyFnHint": "Fn 仅在操作系统能够上报该按键时可用（主要是 macOS）",
  "settings.loadFailed": "设置加载失败，为避免覆盖已有配置，当前无法保存",
  "settings.microphone": "麦克风设备",
  "settings.microphoneHint": "未设置时自动探测；选择后固定使用该设备",
  "settings.microphoneDefault": "自动选择设备",
  "settings.microphoneAutomaticCurrent": "跟随系统（当前：{name}）",
  "settings.microphoneUnavailable": "当前未连接",
  ...
  "settings.polishBaseUrl": "润色服务地址",
  "settings.polishBaseUrlHint": "OpenAI 兼容接口的基础地址",
  "settings.polishBaseUrlPlaceholder": "例如 https://api.openai.com/v1",
  "settings.polishApiKey": "润色服务 API Key",
  "settings.polishApiKeyHint": "凭证仅保存在本机",
  "settings.polishApiKeyPlaceholder": "输入 OpenAI 兼容 API Key",
  "settings.polishModel": "润色模型",
  "settings.polishModelHint": "选择文本润色使用的模型",
  "settings.polishRequired": "开启 AI 润色后，请填写服务地址、API Key 并选择模型",
...
const enUS: Record<MessageKey, string> = {
  ...
  "settings.hotkeyHint": "Click on the right, then press the key you want",
  "settings.hotkeyChange": "Click to record again",
  "settings.hotkeyRecording": "Press any key…",
  "settings.hotkeyQuickChoices": "Common keys",
  "settings.hotkeyUnsupported": "The system did not recognize that key; try another one",
  "settings.hotkeyTimeout": "No key was detected; click again to retry",
  "settings.hotkeyUnavailable": "Keyboard capture is not ready; try again shortly",
  "settings.hotkeyFnHint": "Fn works only when the OS reports it (primarily on macOS)",
  "settings.loadFailed": "Settings failed to load, so saving is disabled to protect existing data",
  "settings.microphone": "Microphone",
  "settings.microphoneHint": "Auto-detect when unset; otherwise always use the selected device",
  "settings.microphoneDefault": "Automatically select a device",
  "settings.microphoneAutomaticCurrent": "Follow system (current: {name})",
  "settings.microphoneUnavailable": "currently disconnected",
  "settings.refreshDevices": "Refresh",
  ...
  "settings.polishBaseUrl": "Polish service URL",
  "settings.polishBaseUrlHint": "Base URL of an OpenAI-compatible endpoint",
  "settings.polishBaseUrlPlaceholder": "For example, https://api.openai.com/v1",
  "settings.polishApiKey": "Polish service API key",
  "settings.polishApiKeyHint": "Credentials are stored on this device only",
  "settings.polishApiKeyPlaceholder": "Enter an OpenAI-compatible API key",
  "settings.polishModel": "Polish model",
  "settings.polishModelHint": "Select the model used for text polishing",
  "settings.polishRequired": "Enter a service URL, API key, and model to enable AI polish",
